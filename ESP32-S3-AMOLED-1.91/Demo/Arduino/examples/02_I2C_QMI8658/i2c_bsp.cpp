...
//#define EXAMPLE_USE_TOUCH   // Implementation for touch screen
...
void I2C_master_Init(void)
{
  i2c_config_t conf = 
  {
    ...
    .sda_io_num = I2C_MASTER_SDA_IO,         // Configure SDA GPIO
    .scl_io_num = I2C_MASTER_SCL_IO,         // Configure SCL GPIO
    .sda_pullup_en = GPIO_PULLUP_ENABLE,
    .scl_pullup_en = GPIO_PULLUP_ENABLE,
    .master = {
      .clk_speed = 300 * 1000,
    },  // Select frequency for the project
    .clk_flags = 0,          // Optional; use I2C_SCLK_SRC_FLAG_* flags to select I2C source clock
  };
