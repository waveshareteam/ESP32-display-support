...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_pos(ui->screen_label_1, -5, 10);
	...
	lv_obj_set_pos(ui->screen_label_2, 64, 11);
	...
	lv_obj_set_pos(ui->screen_label_3, -6, 34);
	...
	lv_obj_set_pos(ui->screen_label_4, 78, 35);
	...
	lv_obj_set_pos(ui->screen_label_5, -5, 61);
	...
	lv_obj_set_pos(ui->screen_label_7, -7, 87);
	...
	lv_obj_set_pos(ui->screen_label_9, -6, 116);
	...
	lv_obj_set_pos(ui->screen_label_6, 66, 63);
	...
	lv_obj_set_pos(ui->screen_label_8, 136, 89);
	...
	lv_obj_set_pos(ui->screen_label_10, 111, 117);
	...
	lv_obj_set_pos(ui->screen_img_4, 123, 63);
